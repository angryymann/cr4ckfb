...
ketik("\x1b[0mPowered By\x1b[1;31m™AngryyMann BRUTEFORCE FB v1.0\n\x1b[1;31mWarning:\x1b[0;00mThis fb hack script is still in testing.\nfollow my github:\n https://github.com/angryymann")
os.system("clear")
os.system("xdg-open https://www.facebook.com/profile.php?id=100078689373767");
try:
...
def banner():
	print("""
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m┌∩┐(◣_◢)┌∩┐┌∩┐(◣_◢)┌∩┐┌∩┐(◣_◢)┌∩┐
\x1b[0;00m © AngryyMann BRUTEFORCE FACEBOOK v1.0
\x1b[1;92m ___________             __     _____________________  ._._.
\x1b[1;92m \_   _____/_ __   ____ |  | __ \_   _____/\______   \ | | |
\x1b[1;96m |    __)|  |  \_/ ___\|  |/ /  |    __)   |    |  _/ | | |
\x1b[1;96m |     \ |  |  /\  \___|    <   |     \    |    |   \  \|\|
\x1b[1;96m \___  / |____/  \___  >__|_ \  \___  /    |______  /  ____
\x1b[1;96m     \/              \/     \/      \/            \/   \/\/
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m┌∩┐(◣_◢)┌∩┐┌∩┐(◣_◢)┌∩┐┌∩┐(◣_◢)┌∩┐
...
\033[92;1m¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
\033[97;1m╔[ \033[92;1mCODED BY  \033[97;1m: \033[93;1mangryymann \033[97;1m \033[93;1m\033[97;1m[\033[92;1m\033[97;1m]
\033[97;1m╠[ \033[92;1mWHATSAPP \033[97;1m: \033[93;1m+158746521
\033[97;1m╠[ \033[92;1mGITHUB   \033[97;1m: \033[93;1mHttps://github.com/angryymann
\033[97;1m╠[ \033[92;1mFACEBOOK \033[97;1m: \033[93;1mДиҩяүү Мдии\033[97;1m[\033[92;1m\033[97;1m]
\033[97;1m\033[93;1m¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤

\033[97;1m\033[93;1m¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
\033[97;1m╠[ \033[92;1mPRO BRUTE FORCE FACEBOOK v1.0
\033[97;1m╚[ \033[92;1mDO NOT BUY IT!!\033[97;1m[\033[92;1m\033[97;1m]
\033[92;1m¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
""")
...
def login():
	...
	try:
		...
		jalan(balmond+l+" LOGIN SUCCESSFUL")
		time.sleep(0.5)
		bot()
	except KeyError:
		jalan(balmond+m+" LOGIN FAILED DEAR (･´з`･)")
		time.sleep(0.5)
		login()
...
def bot():
	try:
		...
		time.sleep(0.5)
		login()
	print(balmond+l+" WAIT WAIT MY DEAR")
	komentar = random.choice(["Hello how are you bro. can i ask wa or not :("])
...
def menu():
	...
	print(u+line)
	print(s+"\n{"+m+"1"+s+"}"+l+" CRACK FROM FRIENDSHIP "+u+"[PRO]")
	print(s+"{"+m+"2"+s+"}"+l+" CRACK FROM FOLLOWERS "+u+"[PRO]")
	print(s+"{"+m+"3"+s+"}"+l+" PUBLIC FRIENDSHIP CRACK "+s+"["+m+"PRO"+s+"]")
	print(s+"{"+m+"4"+s+"}"+l+" CRACK ACCOUNT OLD"+s+"["+m+"BETA"+s+"]")
	print(s+"{"+m+"5"+s+"}"+l+" CRACK ACCOUNT OLD 2007 "+s+"["+m+"BETA"+s+"]")
	print(s+"{"+m+"0"+s+"}"+l+" BACK")
	sayangku = input("\n"+balmond+l+" SELECT => ")
...
def result():
	print(s+"\n{"+m+"1"+s+"}"+l+" Cek Result CP "+k+"{session account}")
	print(s+"{"+m+"2"+s+"}"+l+" Cek Result OK "+k+"{open account}")
	...
	if pilih=="1" or pilih=="01":
		try:
			...
			menu()
		if len(lisaa)==0:
			print("\n"+balmond+k+" CP Results")
			print(balmond+m+" No Results Cp")
			input(balmond+l+" Kembali")
			time.sleep(0.5)
			menu()
		else:
			print("\n"+balmond+l+" CP Results")
			for jisoo in lisaa:
